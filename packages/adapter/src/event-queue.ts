 ...
 * Used by providers where events arrive asynchronously from separate
 * notification handlers, unlike synchronous for-await loops.
 *
 * Pattern:
...
import type { AgentEvent } from '@weft/core/types';
