...
by the caller (your app entry resolves them — kept parameterized so this
module stays a generic Python template).
...
_APP_ROOT = _HERE.parent  # app root (parent of the package that holds this module)
