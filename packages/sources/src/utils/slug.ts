 ...
 * Slug Validation
 *
 * Sources are stored in directories named by slug, and slugs arrive from
 ...
 * letters, digits, hyphens, or underscores. Matches everything
 * generateSourceSlug produces (lowercase alphanumerics + hyphens).
 */
