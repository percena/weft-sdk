...
// (generateMessageId is already exported from core/types/index.ts — no re-export needed here)
...
export interface Session {
  ...
  isFlagged?: boolean
  /** Permission mode for this session ('explore', 'ask', 'auto') */
...
export interface CreateSessionOptions {
   ...
   * the API request for non-reasoning models.
   */
  thinkingLevel?: ThinkingLevel
  /**
